...
public class FrmQuanLyHoaDon extends JFrame implements ActionListener {
	...
	public FrmQuanLyHoaDon() {
		...
		pnlThongTinHD.setBounds(10, 420, 560, 208);
		...
		txtTenKH.setBounds(155, 132, 380, 30);
		...
		txtNVLap.setBounds(154, 98, 380, 30);
		...
		pnlTimKiem.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				...
				new Color(255, 0, 0)));
		pnlTimKiem.setBounds(10, 13, 1130, 96);
		...
		cmbTim.setBounds(184, 22, 719, 30);
		pnlTimKiem.add(cmbTim);
		
		btnTimKiem = new JButton("Tìm kiếm");
		btnTimKiem.setBounds(913, 21, 136, 30);
		...
		pnlHoaDon.setBounds(10, 200, 1140, 187);
		...
		scrHoaDon.setBounds(12, 22, 1120, 154);
		...
		pnlChiTiet.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				...
				new Color(255, 0, 0)));
		pnlChiTiet.setBounds(590, 420, 560, 208);
...
//		 btnLamMoi.setIcon(new ImageIcon("E:\\Phat Trien Ung Dung\\File_GopCuoi_Quoc\\Nhom16_DeTai01_PTUD_13A_2019\\Hinh\\refresh.png"));
		...
		btnLamMoi.setBounds(485, 390, 136, 30);
		add(btnLamMoi);
		...
		btnThoat.setBounds(485, 630, 136, 30);
		add(btnThoat);
		docDuLieuHD();
...
//				Xuất dữ liệu thuốc đã mua vào bảng  dữ liệu thuốc
		...
		radMaHD.addActionListener(this);
		radTenKH.addActionListener(this);
		radTenNV.addActionListener(this);
		radNgayLap.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(radTenKH))
		{
			cmbTim.setModel(cboModetenKH);
		}
		if(o.equals(radTenNV))
		{
			cmbTim.setModel(cboModetenNV);
		}
		if(o.equals(radNgayLap))
		{
