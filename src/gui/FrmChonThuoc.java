...
public class FrmChonThuoc extends JFrame implements ActionListener{
	...
	public FrmChonThuoc() {
		...
		panel.setBackground(new Color(133, 196, 239));
		panel.setBounds(0, 0, 1296, 61);
		contentPane.add(panel);
		panel.setLayout(null);

		lblThuocCoTen = new JLabel("Thuốc: ");
		lblThuocCoTen.setBackground(new Color(133, 196, 239));
		lblThuocCoTen.setFont(new Font("Times New Roman", Font.PLAIN, 30));
		lblThuocCoTen.setHorizontalAlignment(SwingConstants.CENTER);
		lblThuocCoTen.setBounds(10, 11, 1295, 39);
		panel.add(lblThuocCoTen);

		JPanel panel_1 = new JPanel();
		panel_1.setBackground(new Color(133, 196, 239));
		...
		btnThem = new JButton("Thêm số lượng");
		btnThem.setBounds(563, 419, 167, 29);
