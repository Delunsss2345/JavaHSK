...
public class FrmQuanLyNhanVien extends JFrame implements ActionListener, MouseListener {
	...
	public FrmQuanLyNhanVien() {
		...
		txtMaNV.setBounds(103, 73, 250, 25);
		panel.add(txtMaNV);
		...
		txtCMND.setBounds(452, 109, 206, 25);
		panel.add(txtCMND);
		...
		txtTenTK.setBounds(740, 147, 206, 25);
		panel.add(txtTenTK);
		txtTenTK.setEditable(false);
		txtTenTK.setColumns(10);

		JLabel lblLoaiNV = new JLabel("Loại NV:");
		lblLoaiNV.setBounds(970, 109, 73, 25);
		panel.add(lblLoaiNV);
		...
		txtTen.setBounds(740, 75, 206, 25);
		panel.add(txtTen);
		...
		cboLoaiNV.setBounds(1050, 109, 210, 25);
		panel.add(cboLoaiNV);
		...
		txtMaDiaChi.setBounds(1050, 147, 210, 25);
		...
		lblMaDiaChi.setBounds(970, 147, 80, 25);
		...
		cboTrangThai.setBounds(452, 145, 206, 25);
		...
		cboGioiTinh.setBounds(740, 111, 206, 25);
		...
		txtSoDT.setBounds(103, 109, 250, 25);
		panel.add(txtSoDT);
		...
		cboCaLamViec.setBounds(104, 147, 250, 25);
		...
		pnlDanhSachNhanVien.setBounds(10, 335, 1247, 257);
		...
		scrollPane.setBounds(10, 20, 1227, 226);
		...
		btnXoaRong.setBounds(210, 60, 180, 30);
		...
		btnThoat.setBounds(400, 60, 160, 30);
		panel_2.add(btnThoat);
		
		JPanel panel_3 = new JPanel();
		panel_3.setBounds(10, 217, 649, 114);
		panel.add(panel_3);
		panel_3.setBorder(
		...
		radSoDT.setBounds(525, 42, 94, 23);
		panel_3.add(radSoDT);
		...
		btnTimKiem.setBounds(10, 56, 200, 30);
		...
		btnLamMoi.setBounds(220, 56, 200, 30);
