...
public class FrmXemThongTinCaNhan extends JFrame implements ActionListener{
	...
	public FrmXemThongTinCaNhan() {
		...
		btnThoat.setBounds(1100, 85, 146, 40);
		...
		btnCapNhat.setIcon(new ImageIcon("Hinh/update.png"));
		...
		cboGioiTinh.setBounds(720, 72, 82, 23);
		pnlThongTinCoBan.add(cboGioiTinh);

		JLabel lblCCCD = new JLabel("CCCD:");
		lblCCCD.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblCCCD.setBounds(600, 175, 149, 23);
		pnlThongTinCoBan.add(lblCCCD);
		...
		txtCCCD.setFont(new Font("Times New Roman", Font.PLAIN, 19));
		txtCCCD.setHorizontalAlignment(SwingConstants.RIGHT);
		txtCCCD.setToolTipText("Nhập căn cước công dân");
		txtCCCD.setColumns(10);
		txtCCCD.setBounds(720, 168, 300, 20);
		pnlThongTinCoBan.add(txtCCCD);
	...
	public boolean kiemTraDuLieu() {
		...
		String soChungMinh = txtCCCD.getText();
//		String [] soDienThoaiArray = soChungMinh.
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj.equals(btnCapNhat)) {
			...
			nhanVien.setCmnd(txtCCCD.getText());
